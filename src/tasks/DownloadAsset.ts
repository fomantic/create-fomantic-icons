...
export function extractAsset(asset: Asset, filePath: string): Promise<string> {
...
export function startDownload(results: PromptResults): Promise<PathResults> {
  return new Promise((resolve) => {
...
export default function run(results: PromptResults): Promise<PathResults> {
  return new Promise((resolve) => {
    Logger.log();
